...
<body id="page-top"><a class="menu-toggle rounded" href="#"><i class="fa fa-bars"></i></a>
        ...
        <div class="container"><button data-toggle="collapse" class="navbar-toggler d-none" data-target="#"></button>
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav sidebar-nav" id="sidebar-nav">
                    ...
                    <li class="nav-item sidebar-nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="#services">View Account</a></li>
    ...
    <header class="d-flex masthead" style="background-image:url('assets/img/bg-masthead.jpg');">
        <div class="container my-auto text-center">
            <h1 class="display-1 text-primary mb-1">Hi User</h1>
            <h3 class="mb-5"></h3><a class="btn btn-primary btn-xl js-scroll-trigger" role="button" href="#services">View Details&nbsp;</a><a class="btn btn-primary btn-xl js-scroll-trigger" role="button" href="#services" style="margin: 9px;">Change Password</a>
            <div class="overlay"></div>
        </div>
    </header>
    <div></div>
    <section id="services" class="content-section bg-primary text-white text-center" style="margin: -1px;height: 705px;">
        <div class="container">
            <div class="content-section-heading">
                <h2 class="mb-5" style="width: 438px;">Account Details</h2>
            </div>
            <div class="row">
                <div class="col">
                    <div class="row">
                        <div class="col-xl-7 offset-xl-0">
                            <p data-aos="fade-up" data-aos-duration="650">Name : Hi</p>
                            <p data-aos="fade-up" data-aos-duration="650">Registration Number :&nbsp;</p>
                            <p data-aos="fade-up" data-aos-duration="650">Phone Number :&nbsp;</p>
                            <p data-aos="fade-up" data-aos-duration="650">??????</p>
                            <p data-aos="fade-up" data-aos-duration="650">Paragraph</p>
                            <p data-aos="fade-up" data-aos-duration="650">Paragraph</p>
                            <p data-aos="fade-up" data-aos-duration="650">Paragraph</p>
                            <p data-aos="fade-up" data-aos-duration="650">Paragraph</p>
                        </div>
