...
<body id="page-top"><a class="menu-toggle rounded" href="#"><em class="fa fa-bars"></em></a>
        ...
        <div class="container"><button data-toggle="collapse" class="navbar-toggler d-none" data-target="#"></button>
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav sidebar-nav" id="sidebar-nav">
                    ...
                    <li class="nav-item sidebar-nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="#services">Change Password</a></li>
    ...
    <header class="d-flex masthead" style="background-image:url('assets/img/bg-masthead.jpg');">
        <div class="container my-auto text-center">
            <h1 class="display-1 text-primary mb-1">Change Password !</h1>
            <h3 class="mb-5"></h3><a class="btn btn-primary btn-xl js-scroll-trigger" role="button" href="#services">ChangePassword</a>
    ...
    <section id="services" class="content-section bg-primary text-white text-center" style="margin: -1px;height: 597px;">
        <div class="container">
            <div class="content-section-heading">
                <h2 class="mb-5" style="width: 438px;">Change Password</h2>
            </div>
            <div class="row">
                <div class="col">
                    <form class="bootstrap-form-with-validation">
                        <div class="form-group"><input class="form-control" type="text" id="text-input" name="text-input" style="width: 440px;" placeholder="Enter New Password"></div>
                        <div class="form-group"><input class="form-control" type="email" id="email-input" name="email-input" placeholder="Confirm New Password" style="width: 439px;"></div>
                        <div class="form-group" style="width: 463px;"><button class="btn btn-primary" type="submit" style="width: 158px;">Change Password</button></div>
                    </form>
                </div>
            </div>
        </div>
